...
export const config: ConfigType = {
  ...
  interactiveDemo: {
    // --- بداية التعديل النهائي والدقيق ---
    stageZero: {
      title: "شف كيف وكيلنا الذكي يبيع بدالك!",
      // السيناريو الكامل والدقيق للمحاكاة التفاعلية
      script: [
        ...
        // الرد التسويقي المفصل الذي يبرز القيمة
        ...
        // لحظة الذكاء والبيع الإضافي (Upsell)
    ...
    // المراحل التالية تبقى كما هي، وسيتم الانتقال إليها بعد الضغط على زر CTA
    stageOne: {
    ...
    stageTwo: {
      ...
      form: {
        ...
        agentRoles: [
          ...
          { id: "data-analyst", name: "📊 محلل بياناتك", enabled: false },
        ],
