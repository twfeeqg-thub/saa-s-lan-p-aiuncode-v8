...
export const config = {
  ...
  sections: {
    ...
    painPoints: true,
    solution: true,
    // سنضيف مفتاح التحكم بالقسم الجديد هنا لاحقًا في الخطوة 11
  ...
  interactiveDemo: {
    ...
    // المرحلة الأولى: اختيار السيناريو
    stageOne: {
